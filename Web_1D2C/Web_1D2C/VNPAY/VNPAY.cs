...
namespace Web_1D2C.VNPAY
{
    public class BankPayment
    {
        ...
        public BankPayment(string name, string code, string img)
        {
            this.Name = name;
            this.Code = code;
            this.Img = img;
    ...
    public class VNPAY
    {
        ...
        public string VNPAY_TMNCODE = "NJ7A7X57";
        public string VNPAY_HASH_SECRECT = "ARKPJZAECUDWPOZURDDEYZHNNWFBQAOO";
        public string VNPAY_VERSION = "2.0.0";
        public string URL_VNPAY_REFUND = "none";
        public List<BankPayment> ListBank = new List<BankPayment>();

        public VNPAY()
        {
            ListBank.Add(new BankPayment("Ngân hàng Quốc dân (NCB)", "NCB", "https://sandbox.vnpayment.vn/apis/assets/images/bank/ncb_logo.png"));
            ListBank.Add(new BankPayment("Thẻ quốc tế Visa", "VISA", "https://sandbox.vnpayment.vn/apis/assets/images/bank/visa_logo.png"));
            ListBank.Add(new BankPayment("Vietinbank", "VIETINBANK", "https://sandbox.vnpayment.vn/apis/assets/images/bank/vietinbank_logo.png"));
            ListBank.Add(new BankPayment("Momo QR Scan", "VNPAYQR", "https://static.mservice.io/img/logo-momo.png"));

        }

        public string GetBankingURL(double amount, string bankcode, string idTicket, DateTime createDate, string language = "vn")
        {
            ...
            vnpay.AddRequestData("vnp_TxnRef", idTicket);
            vnpay.AddRequestData("vnp_OrderInfo", "Thanh toan cho hoa don " + idTicket);
            vnpay.AddRequestData("vnp_OrderType", "250006"); //default value: other
            vnpay.AddRequestData("vnp_Amount", (amount * 100).ToString());
            vnpay.AddRequestData("vnp_ReturnUrl", "http://localhost:59279/GioHang/KetQuaThanhToanOnline");
